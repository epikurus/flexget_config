...
* Alternative names for series can be defined directly with the series plugin in the series.yml file
* Anime names configuration is done in the anime.yml file and should follow the structure provided in the example
